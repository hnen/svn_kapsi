...
class Texture3 {
    ...
    private void Init( float [,,] data ) {
        ...
        GL.TexParameter( TextureTarget.Texture3D, TextureParameterName.TextureWrapS, (int)OpenTK.Graphics.OpenGL.All.Clamp );
        GL.TexParameter( TextureTarget.Texture3D, TextureParameterName.TextureWrapT, (int)OpenTK.Graphics.OpenGL.All.Clamp );
        GL.TexParameter( TextureTarget.Texture3D, TextureParameterName.TextureWrapR, (int)OpenTK.Graphics.OpenGL.All.Clamp );
