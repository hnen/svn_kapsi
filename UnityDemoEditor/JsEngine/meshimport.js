function meshimport_import(filename, onready) {
	...
	file_loadBin(filename, function(data) {
		var object = {};
		p_meshimport_readMesh(data, object);
		console.log("Loaded mesh! bytes=" + data.length);
		object.vb_vertices = gl_createVB(object.vertices_farr, 3);
		object.vb_normals = gl_createVB(object.normals_farr, 3);
		object.vb_uv = gl_createVB(object.uv_farr, 2);
		object.ib = gl_createIB(object.triangleSubmeshes[0]);
		object.triangles = object.triangleSubmeshes[0];
		onready(object);
	});
