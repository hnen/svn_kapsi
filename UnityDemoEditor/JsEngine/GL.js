...
function gl_loadShaderFromScripts(vs_src, fs_src, onshaderlinked) {
    ...
    LoadShader(vs_src, program, GL.VERTEX_SHADER, function(_vs) { vs = _vs; if ( fs ) finalize(); } );
    LoadShader(fs_src, program, GL.FRAGMENT_SHADER, function(_fs) { fs = _fs; if ( vs ) finalize(); } );
}
